...
本项目是一个微信小程序 + H5 方向的 B2B2C 虚拟商品供货平台。平台负责商品供给、审核、支付、履约、结算和风控；渠道商审核入驻并缴纳保证金后，可以拥有自己的小店、客服入口、商品售价和推广链接；用户在渠道小店购买虚拟商品，渠道商赚取售价与供货价之间的差价。

本项目不做多级分销、返佣、团队业绩奖、邀请奖励或拉人头收益。后续允许受控两级渠道供货：平台 -> 一级渠道商 -> 二级渠道商 -> 消费者；收益来自供货价差，不按招募人数、团队订单或返佣比例计算。
